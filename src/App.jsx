...
import PlacementPilot from "./pilot/PlacementPilot";
import FinalPlacementPortal from "./final/FinalPlacementPortal";
 
const TESTS = [
{
  id: "test9", title: "Monday — Number System", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "Divisibility · Factors · HCF-LCM · Modular Arithmetic · Factorials · Indices", status: "live", color: "#4f46e5",
},
{
  id: "test10", title: "Tuesday — Percentages", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "Reverse % · Successive Change · Elections · Marks · Growth · Mixtures · DI", status: "live", color: "#0891b2",
},
{
  id: "test11", title: "Wednesday — Profit and Loss", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "Reverse CP · Markup · Discounts · False Weights · Mixed Lots · Traders", status: "live", color: "#ea580c",
},
{
  id: "test12", title: "Thursday — Ratio and Proportion", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "Proportion · Variation · Compound Ratio · Partnership · Alligation · Wages", status: "live", color: "#7c3aed",
},
{
  id: "test13", title: "Friday — Averages", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "Missing Values · Replacement · Combined Average · Error · Speed · Weighted Sets", status: "live", color: "#059669",
},
{
  id: "test14", title: "Saturday — Simple and Compound Interest", subtitle: "Placement Mastery Series · Verified Solutions",
  questions: 150, duration: "30 sec/Q · Pausable", parts: "20 Foundation · 55 Placement Core · 45 Advanced · 30 Company Challenge",
  sections: "SI · CI · Variable Rates · Half/Quarterly · Present Value · Depreciation", status: "live", color: "#be123c",
},
//   {
//     id: "test1",
//     title: "Mock Test — 1",
...
//   color: "#0891b2",
// },
/* Older aptitude series hidden while the weekly programme is active.
{
  id: "test7",
  title: "Mock Test — Aptitude Series 1",
  subtitle: "Placement Aptitude Assessment · 90 Questions · 120 Minutes",
  questions: 90,
  duration: "120 min",
  parts: "Aptitude Only · Single Continuous Paper",
  sections: "Divisibility · Number System · Factors · LCM-HCF · Percentages · Profit & Loss · SI-CI",
  status: "live",
  color: "#0f766e",
},
{
  id: "test8",
  title: "Mock Test — Aptitude Series 2",
  subtitle: "Commercial Maths Deep Dive · 60 Questions · 90 Minutes",
  questions: 60,
  duration: "90 min",
  parts: "Aptitude Only · Medium to Medium-Hard",
  sections: "Percentages · Profit & Loss · Simple & Compound Interest",
  status: "live",
  color: "#c2410c",
},
*/
...
export default function App() {
  ...
  const portalMode = new URLSearchParams(window.location.search);
  if (portalMode.get("pilot") === "1") return <PlacementPilot />;
  if (portalMode.get("legacy") !== "1") return <FinalPlacementPortal />;
