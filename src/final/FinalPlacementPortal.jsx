...
const numericalTopics=[
  ...
  {title:"Mixtures and Alligation",kind:"mixture",color:"#0f766e",coverage:"25 patterns: weighted blends, alligation, dilution, evaporation, replacement, alloys, adulteration and concentration caselets",ready:true,quality:true},
  {title:"Time and Work",kind:"work",color:"#1d4ed8",coverage:"25 patterns: individual and team rates, joining/leaving, alternate work, workforce scaling, wages and productivity",ready:true,quality:true},
  {title:"Pipes and Cisterns",kind:"pipes",color:"#0369a1",coverage:"25 patterns: inlets, outlets, leaks, delayed valves, partial tanks, cyclic schedules and volumetric flow",ready:true,quality:true},
  {title:"Time, Speed and Distance",kind:"distance",color:"#b45309",coverage:"25 patterns: average and relative speed, meetings, catch-up, races, circular tracks, stoppages and route caselets",ready:true,quality:true},
  {title:"Trains, Boats and Streams",kind:"trainsBoats",color:"#c2410c",coverage:"25 patterns: poles, platforms, bridges, train crossings, upstream-downstream, round trips and river crossing",ready:true,quality:true},
  {title:"Algebra",kind:"algebra",color:"#be185d",coverage:"25 patterns: linear and quadratic equations, identities, indices, progressions, functions, variation and modelling",ready:true,quality:true},
  {title:"Mensuration",kind:"mensuration",color:"#9f1239",coverage:"25 patterns: plane figures, paths, circles, cylinders, cones, spheres, tanks and solid transformations",ready:true,quality:true},
  {title:"Permutation and Combination",kind:"permutation",color:"#6d28d9",coverage:"25 patterns: arrangements, selections, restrictions, circular order, distributions, roles and grid routes",ready:true,quality:true},
  {title:"Probability",kind:"probability",color:"#9333ea",coverage:"25 patterns: coins, dice, cards, replacement, conditional probability, Bayes, binomial and risk caselets",ready:true,quality:true},
  {title:"Elementary Statistics",kind:"statistics",color:"#0f766e",coverage:"25 patterns: mean, median, mode, dispersion, grouped data, quartiles, index numbers and combined variance",ready:true,quality:true},
...
const verbalTopicModules=[
  {title:"Error Detection",kind:"errorDetection",coverage:"25 patterns: agreement, tense, modifiers, parallelism, pronouns, articles, prepositions, conditionals and usage traps"},
  {title:"Sentence Correction",kind:"sentenceCorrection",coverage:"25 patterns: rule-based replacement, concise expression, comparison, correlation, reported speech and formal usage"},
  {title:"Grammar Fundamentals",kind:"grammarFundamentals",coverage:"25 patterns: parts of speech, agreement, tense sequence, articles, pronouns, modifiers, clauses and sentence structure"},
  {title:"Sentence Completion",kind:"sentenceCompletion",coverage:"25 patterns: connectors, tense, modals, collocations, contextual precision, complements and professional tone"},
  {title:"Vocabulary",kind:"vocabulary",coverage:"25 patterns: contextual meaning, usage, nuance, roots, register, semantic precision and inference from contrast"},
  {title:"Synonyms and Antonyms",kind:"synonymsAntonyms",coverage:"25 patterns: contextual synonyms, opposites, near-synonym distinctions, formal replacements and advanced vocabulary"},
  {title:"Idioms and Phrases",kind:"idiomsPhrases",coverage:"25 patterns: workplace idioms, figurative meaning, contextual interpretation and misleading literal readings"},
  {title:"Cloze Tests",kind:"clozeTests",coverage:"25 patterns: passage cohesion, connectors, collocations, grammar, vocabulary, tone and contextual conclusions"},
  {title:"Para Jumbles",kind:"paraJumbles",coverage:"25 patterns: opening sentences, pronoun links, chronology, cause-effect, examples, contrasts and conclusions"},
  {title:"Reading Comprehension",kind:"readingComprehension",coverage:"25 patterns: main idea, detail, inference, tone, purpose, title, vocabulary, evidence and application"},
  {title:"Critical Reasoning",kind:"criticalReasoning",coverage:"25 patterns: assumptions, strengthen/weaken, flaws, conclusions, paradoxes, evaluation and evidence sufficiency"},
  {title:"One-word Substitution",kind:"oneWordSubstitution",coverage:"25 patterns: people, professions, documents, institutions, qualities, fears, government and precise formal terms"},
].map(topic=>({...topic,color:"#059669",ready:true,quality:true}));
...
const sections=[
  ...
  {id:"verbal",title:"Verbal Ability",subtitle:"Grammar, vocabulary, comprehension and critical reasoning",color:"#059669",count:verbalTopicModules.length},
];
...
export default function FinalPlacementPortal(){
  ...
  if(!activeSection)return <div style={shell}><div style={card}>
    ...
    <p style={{color:"#64748b",lineHeight:1.65,maxWidth:760}}>Build speed, accuracy and reasoning depth through structured topic practice. Numerical Ability, Logical Reasoning and Verbal Ability modules are available with verified topic-wise assessment practice.</p>
